          ...
          <div class="card-body">
             ...
             @csrf
                ...
                <div class="form-group">
                   ...
                   class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $category->description) }}</textarea>
                   @error('description')
                  <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                  </span>
   ...
   <script>
      ...
      $(function() {
         ...
         $('#input_category_title').change(function(){
            let title = $(this).val();
            let parent_category = $('#select_category_paren').val() ?? "";
         ...
         // $('#button_category_thumbnail').filemanager('file');
      });
   </script>
@endpush
